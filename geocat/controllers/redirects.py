...
class GeoCatRouter(http.Controller):
    ...
    @http.route(['/docs'], type='http', auth='public', website=True, sitemap=False)
    ...
    @http.route(['/docs/<path:path>'], type='http', auth='public', website=True, sitemap=False)
    ...
    @http.route(['/news/<path:path>'], type='http', auth='public', website=True, sitemap=False)
    ...
    @http.route(['/feed', '/feed/'], type='http', auth='public', website=True, sitemap=False)
